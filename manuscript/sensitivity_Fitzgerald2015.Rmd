...
run_everything = TRUE
sensitivity = TRUE
sens_papers <- "Fitzgerald 2015" #c("Camp 2012 (1)", "Camp 2012 (2)", "Camp 2012 (3)", "Camp 2012 (4)", "Fitzgerald 2015", "Gottschalk 2018", "Ju 2017", "Xiong 2015 (1)", "Xiong 2015 (2)")
library("worcs")
library(ggplot2)
library(kableExtra)
library(DT)
...
```{r, results = "asis"}
cat("**This is a sensitivity analysis; the study Fitzgerald 2015 has been removed from the data.**")
```
